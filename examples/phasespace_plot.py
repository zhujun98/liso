...
if __name__ == "__main__":
    psplot2 = PhaseSpacePlot('astra', 'astra_impactt_combined/astra/injector.0400.001',
                             filter_size=2,
                             tail=0.1,
                             halo=0.2)
    ...
    psplot1 = PhaseSpacePlot('impactt', 'astra_impactt_combined/impactt/fort.107', charge=3.1e-12)
    psplot1.scatter('x', 'y')
