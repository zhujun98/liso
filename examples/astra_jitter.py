...
jt.add_jitter('gun_gradient', value=110, sigma=-0.001)  # nominal value = 110, standard deviation = 110 * 0.001
...
jt.add_jitter('tws_phase', value=0.0, sigma=0.01)  # nominal value = 0.0, standard deviation = 0.01

jt.workers = 1  # No. of threads
jt.verbose = True  # print the jitter process
